                          ...
                          <div class="card-body">
                            <form method="post">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="inputNombreUsuario" class="form-control"  name="addInputNombreUsuario" placeholder="Ingrese nombre usuario" required minlength="6" maxlength="50">
                              </div>
							                <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" id="inputRol" class="form-control"  name="addInputRol" placeholder="Ingrese el rol que desempeña" required minlength="6" maxlength="50">
                              </div>
                              <div class="form-group">
  ...
  <?php
     ...
     */
    $addUsuarioModel = UsuarioController::create();

?>
<script>
  function limpiarFormulario() {
    document.getElementById("inputNombreUsuario").value = ""; // Limpiar campo de nombre usuario
    document.getElementById("inputCorreo").value = ""; // Limpiar campo de correo
    document.getElementById("inputRol").value = ""; // Limpiar campo de rol
